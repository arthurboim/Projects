...
public class Item {
	...
	private boolean marketPlaceRequestSuccess;
	...
	private APIRequetsStatus APIRequestStatus;
	private ArrayList<SellerPrice> pricesList;
	...
	public void SetNewMarketPlacePrice(double newPrice)
	{
...
//		return "supplierCode = " +supplierCode+ " isPrime=" + isPrime + " inStock=" + inStock +" Updated price= "+currentSupplierPrice+ " Updated TAX = "+currentTax;
	...
	public void rest()
	{
		...
		this.quantitiyStatus				= QuantitiyChangeStatus.NoChange;
		this.priceStatus					= PriceChangeStatus.NoChange;
		this.APIRequestStatus				= APIRequestStatus.Success;
	}
	...
	public boolean isMarketPlaceRequestSuccess() {
		return marketPlaceRequestSuccess;
	}

	public void setMarketPlaceRequestSuccess(boolean marketPlaceRequestSuccess) {
		this.marketPlaceRequestSuccess = marketPlaceRequestSuccess;
	}

	public APIRequetsStatus getAPIRequestStatus() {
		return APIRequestStatus;
	}

	public void setAPIRequestStatus(APIRequetsStatus aPIRequestStatus) {
		APIRequestStatus = aPIRequestStatus;
	}

	public ArrayList<SellerPrice> getPricesList() {
		return pricesList;
	}

	public void setPricesList(ArrayList<SellerPrice> pricesList) {
